...
Describe "PSScriptAnalyzer rule-sets" -Tag Build , ScriptAnalyzer {
    ...
    [regex] $ignoreFolders = "classes|tests"
    $scripts = Get-ChildItem $ModuleBase -Include *.ps1, *.psm1, *.psd1 -Recurse | Where-Object fullname -notmatch $ignoreFolders
